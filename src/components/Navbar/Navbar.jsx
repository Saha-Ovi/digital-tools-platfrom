    ...
    return (
        <div className='container mx-auto my-5'>
            <div className="navbar bg-base-100 shadow-sm p-4">
                ...
                <div className="navbar-end gap-4 lg:gap-5">
                    <div class="indicator">
                        <span class="indicator-item badge badge-xs lg:badge-sm badge-secondary">{cart.length}</span>
                        <a className='text-xl lg:text-3xl text-[#101727] hover:cursor-pointer' >
